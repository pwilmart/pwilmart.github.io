...
- length of the protein sequence matters, but is ignored
- protein database size is not really the number of protein sequences
- protein database size is the unique theoretical peptide space size
